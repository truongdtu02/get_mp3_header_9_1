...
namespace get_mp3_header_9_1
{
    class MP3_header
    {
        ...
        public bool IsValidHeader_old(bool first_header, MP3_header MP3_header_first, byte[] buff, int i_buff, int buff_length)
        {
            //get infor header
        ...
        //constructor
        public MP3_header(byte[] _Mp3_buff, int _Mp3_buff_length)
        {
            mp3_buff = _Mp3_buff;
